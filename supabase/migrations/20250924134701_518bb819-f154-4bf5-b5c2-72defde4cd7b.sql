...
-- Criar política para UPDATE via backend com service_role
CREATE POLICY "Backend pode atualizar agendamentos"
ON public.agendamentos
FOR UPDATE
TO service_role
USING (true)
...
-- Criar política para DELETE via backend com service_role
CREATE POLICY "Backend pode deletar agendamentos"
ON public.agendamentos
FOR DELETE
TO service_role
USING (true);
